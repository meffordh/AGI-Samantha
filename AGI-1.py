...
def generate_text_vision(image_url):
    response = client.chat.completions.create(
        ...
        messages=[{
            "role": "user",
            "content": [
                {"type": "text", "text": "What’s in this image? Be descriptive but concise. Include all important details, but write densely."},
